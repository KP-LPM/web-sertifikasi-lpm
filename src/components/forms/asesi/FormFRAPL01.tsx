...
export function EFormApl01({
  ...
  React.useEffect(() => {
    const handleScroll = () => {
      ...
      setTimeout(() => {
        document
          .getElementById("tujuan-asesmen-row")
  ...
  return (
    <div className="bg-white border border-slate-300 shadow-sm p-8 w-full mx-auto font-sans text-xs sm:text-sm text-slate-800 space-y-6">
      ...
      <div>
        ...
        <h4 className="font-bold mb-2 text-xs mt-4">
        ...
        <h3 className="font-bold text-sm mb-1 mt-6">
        ...
        <div className="overflow-x-auto mb-6 ">
          <table className="w-full border-collapse border border-slate-300 min-w-[600px] text-xs">
            <tbody>
              <tr>
                <td
                  className="border border-slate-300 p-2 font-semibold w-1/3 bg-white whitespace-nowrap"
                  rowSpan={2}
                >
                  Skema Sertifikasi
                </td>
                <td className="border border-slate-300 p-2 font-semibold bg-white w-1/6 whitespace-nowrap">
                  Judul :
                </td>
              ...
              <tr
                ...
                className={
                  highlightTujuan && !formData.tujuan
                    ? "bg-red-50 transition-colors shadow-inner"
                    : ""
                }
              >
                <td
                ...
                <td className="border border-slate-300 p-2 text-center">
                  <input
                    ...
                    name="tujuan"
                    checked={formData.tujuan === "Sertifikasi"}
                    onChange={() => handleChangeTujuan("Sertifikasi")}
                  />
                </td>
              ...
              >
                <td className="border border-slate-300 p-2 text-center">
                  <input
                    ...
                    disabled={formData?.readOnly || formData?.isAdmin}
                    name="tujuan"
                    checked={formData.tujuan === "PKT"}
                    onChange={() => handleChangeTujuan("PKT")}
                  />
                </td>
                <td className="border border-slate-300 p-2">
              ...
              >
                <td className="border border-slate-300 p-2 text-center">
                  <input
                    ...
                    disabled={formData?.readOnly || formData?.isAdmin}
                    name="tujuan"
                    checked={formData.tujuan === "RPL"}
                    onChange={() => handleChangeTujuan("RPL")}
                  />
                </td>
                <td className="border border-slate-300 p-2">
              ...
              >
                <td className="border border-slate-300 p-2 text-center">
                  <input
                    ...
                    onChange={() => handleChangeTujuan("Lainnya")}
                  />
                </td>
          ...
          <table className="w-full border-collapse border border-slate-300 min-w-[500px] text-xs">
            <thead>
              <tr className="bg-[#ebf0fa] border-b border-slate-300 text-slate-800">
                ...
                <th className="border border-slate-300 px-4 py-3 font-bold uppercase tracking-wider text-center w-1/5 sticky top-0 z-20 bg-[#ebf0fa]">
                  Memenuhi Syarat
                </th>
                <th className="border border-slate-300 px-4 py-3 font-bold uppercase tracking-wider text-center w-1/5 sticky top-0 z-20 bg-[#ebf0fa]">
            ...
            <tbody>
              ...
              {!formData.schemeDetail?.persyaratanDasar?.length &&
                ...
                !formData.schemeDetail?.buktiKompetensi?.length && (
                  <tr>
                    <td className="border border-slate-300 p-2">
                      Belum ada persyaratan diatur.
                    </td>
              ...
              <tr>
                <td className="border border-slate-300 p-4 w-1/2 align-top bg-white">
                  ...
                  <div className="flex gap-2 items-center mt-2">
                    <input
                      type="radio"
                      checked={formData?.rekomendasi === "Diterima"}
                      onChange={() =>
                        formData?.isAdmin &&
                  ...
                  <div className="flex gap-2 items-center">
                    <input
                      type="radio"
                      checked={formData?.rekomendasi === "Tidak Diterima"}
                      onChange={() =>
                        formData?.isAdmin &&
                  ...
                  <div className="mt-4">
                    ...
                    <textarea
                      value={(formData?.catatan as string) || ""}
                      onChange={(e) =>
                        formData?.isAdmin &&
                  ...
                  <div className="border-t border-slate-300 pt-4 mt-6">
                    ...
                    <div className="mb-4">
                      ...
                      {formData?.isAdmin ? (
                        <input
                          type="text"
                          className="border border-slate-300 rounded p-1 text-xs outline-none focus:border-[#008BE3] focus:ring-1 focus:ring-[#008BE3]"
                          value={(formData.namaAdmin as string) || ""}
                          onChange={(e) =>
