            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
              <div className="p-6">
                ...
                <p className="text-slate-600 text-sm">
                  Pastikan semua data yang Anda isi sudah benar. Pengajuan ini
                  akan diteruskan kepada tim Asesor untuk diverifikasi.
                </p>
              </div>
          ...
          <div className="max-w-200 mx-auto animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="max-w-200 mx-auto bg-white rounded-2xl shadow-sm border border-slate-200 p-8 md:p-12 space-y-8 relative mb-8 text-slate-800 text-sm">
              ...
              <table className="w-full border-collapse border border-slate-300">
                <tbody>
                  <tr>
                    <td className="border border-slate-300 p-2 font-semibold bg-white w-48">
                      Nama Asesi:
                    </td>
                  ...
                  <tr className="bg-slate-100 font-bold">
                    ...
                    <td className="border border-slate-300 p-2 text-center w-16">
                      YA
                    </td>
                    <td className="border border-slate-300 p-2 text-center w-16">
                      TIDAK
                  ...
                  <tr>
                    ...
                    <td className="border border-slate-300 p-2 text-center align-middle">
                      <input
                        ...
                        checked={bandingForm.dijelaskan === true}
                        onChange={() =>
                          setBandingForm({ ...bandingForm, dijelaskan: true })
                        }
                      />
                    </td>
                    <td className="border border-slate-300 p-2 text-center align-middle">
                      <input
                        type="checkbox"
                        className="w-4 h-4 cursor-pointer"
                        checked={bandingForm.dijelaskan === false}
                        onChange={() =>
                          setBandingForm({ ...bandingForm, dijelaskan: false })
                        }
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td className="border border-slate-300 p-2 text-center align-middle">
                      <input
                        type="checkbox"
                        className="w-4 h-4 cursor-pointer"
                        checked={bandingForm.didiskusikan === true}
                        onChange={() =>
                          setBandingForm({ ...bandingForm, didiskusikan: true })
                        }
                      />
                    </td>
                    <td className="border border-slate-300 p-2 text-center align-middle">
                      <input
                        type="checkbox"
                        className="w-4 h-4 cursor-pointer"
                        checked={bandingForm.didiskusikan === false}
                        onChange={() =>
                          setBandingForm({
                            ...bandingForm,
                            didiskusikan: false,
                  ...
                  <tr>
                    ...
                    <td className="border border-slate-300 p-2 text-center align-middle">
                      <input
                        type="checkbox"
                        className="w-4 h-4 cursor-pointer"
                        checked={bandingForm.melibatkanOrangLain === true}
                        onChange={() =>
                          setBandingForm({
                            ...bandingForm,
                    ...
                    <td className="border border-slate-300 p-2 text-center align-middle">
                      <input
                        type="checkbox"
                        className="w-4 h-4 cursor-pointer"
                        checked={bandingForm.melibatkanOrangLain === false}
                        onChange={() =>
                          setBandingForm({
                            ...bandingForm,
                  ...
                  <tr>
                    <td className="border border-slate-300 p-4" colSpan={3}>
                      ...
                      <div className="text-xs text-slate-500 mt-2 italic">
                        Anda mempunyai hak mengajukan banding jika Anda menilai
                        Proses Asesmen tidak sesuai SOP dan tidak memenuhi
                        Prinsip Asesmen.
                      </div>
                    </td>
                  </tr>
          ...
          <table className="w-full text-left border-collapse min-w-[1600px]">
            <thead>
              <tr className="bg-[#0F172A] border-b border-[#0F172A]">
                <th className="px-6 py-4 text-xs font-bold text-white/90 uppercase tracking-wider text-left whitespace-nowrap min-w-15 sticky top-0 z-20 bg-[#0F172A]">
                  No
                </th>
