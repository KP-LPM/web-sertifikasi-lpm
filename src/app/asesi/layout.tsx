...
import SidebarAsesi from '@/components/SidebarAsesi'; 
import HeaderAsesi from '@/components/HeaderAsesi';
...
export default function AsesiLayout({ children }: { children: React.ReactNode }) {
  return (
    <SessionProvider>
      <AppProvider>
        <LayoutInner>
