      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs text-gray-400 font-bold tracking-wider uppercase leading-4">
            Lihat riwayat dan arsip batch asesmen yang telah selesai beserta detail kandidat di dalamnya.
          </p>
        </div>
      </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <button
                            ...
                            className="bg-[#008BE3] hover:bg-[#0076C2] text-white px-3.5 py-1.5 rounded-lg font-bold text-xs shadow-xs transition-colors inline-flex items-center gap-1.5 cursor-pointer"
                          >
