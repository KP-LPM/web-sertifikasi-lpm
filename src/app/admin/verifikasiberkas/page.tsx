...
export default function UsersManagement() {
  ...
  const confirmRevisi = async () => {
    if (userToVerify) {
      if (userToVerify.role === "asesi") {
        const rawTtdAdmin = apl01FormData.ttdAdmin;
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const extractedTtdAdmin = typeof rawTtdAdmin === 'object' && rawTtdAdmin !== null ? (rawTtdAdmin as any).data : rawTtdAdmin;
        
        const currentAdminUrl = (extractedTtdAdmin as string) || userToVerify.verificationData?.adminSignatureUrl || null;
  ...
  const handleSaveVerifyDraft = () => {
    ...
    if (activeVerifyTab === "apl01") {
      ...
      currentAdminUrl = (extractedTtdAdmin as string) || null;
    }
