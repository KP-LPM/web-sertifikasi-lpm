export const AVAILABLE_SCHEMES = [
  {
    ...
    units: [
      ...
      },
      {
        ...
        elemen:[
          {
            title: 'Menyiapkan pelaksanaan pengawasan kinerja',
            kuk: [
              '1.1 Pengetahuan tentang manajemen supervisi dijelaskan.',
              '1.2 Uraian pekerjaan dan prosedur kerja tenaga kerja yang diawasi diidentifikasi.',
              '1.3 Target produksi diidentifikasi.',
              '1.4 Perangkat pengawasan kinerja disiapkan.',
            ],
          },
          {
            title: 'Melakukan pengawasan kinerja tenaga kerja',
            kuk: [
              '2.1 Prosedur kerja yang benar diberitahukan kepada tenaga kerja yang melakukan kesalahan prosedur kerja.',
              '2.2 Penempatan tenaga kerja diatur kembali pada kndisi tertentu.',
            ],
          },
          {
            title: 'Melaporkan pelaksanaan pengawasan kinerja',
            kuk: [
              '3.1 Semua kegiatan yang dilakukan dicatat.',
              '3.2 Kegiatan pengawasan kinerja dilaporkan sesuai prosedur.',
            ]
          }
        ]
      },
    ...
    persyaratanDasar: [
      ...
      },
      {
        ...
        description: 'Telah mengikuti magang/praktik kerja industri bidang kewirausahaan industri.',
      },
    ],
    buktiAdministratif: ['KTP dan KTM', 'Pasfoto berwarna ukuran 3 x 4'],
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        elemen: [
          {
            title: 'Menganalisis kebijakan pemerintah yang terkait dengan kelangsungan organisasi',
            kuk: [
      ...
      },
      {
        ...
        elemen: [
          {
            title: 'Mengumpulkan data/informasi tentang pegawai/karyawan beserta posisi/jabatan',
            kuk: [
    ...
    persyaratanDasar: [
      ...
      },
      {
        ...
        description: 'Telah menyelesaikan kerja praktik/magang pada bidang kehumasan.',
      },
    ],
    buktiAdministratif: ['KTP dan KTM', 'Pasfoto berwarna ukuran 3 x 4'],
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        elemen: [
          {
            title: 'Mengidentifikasi fakta dan peristiwa dalam teks asal (what)',
            kuk: [
          ...
          {
            title: 'Mengidentifikasi informasi akurat tentang waktu peristiwa dalam teks asal (when)',
            kuk: [
          ...
          {
            title: 'Mengidentifikasi penyebab dan alasan terjadinya peristiwa yang tercantum dalam teks asal (why)',
            kuk: [
          ...
          {
            title: 'Mengidentifikasi cara terjadinya peristiwa yang tercantum dalam teks asal (how)',
            kuk: [
      ...
      },
      {
        ...
        title: 'Menangkap Pesan Kalimat melalui Berbagai Macam Kelas Kata Bahasa Asal',
        elemen: [
          {
      ...
      },
      {
        ...
        elemen: [
          ...
          {
            title: 'Mengidentifikasi unsur gestur dan kebiasaan khas dalam bahasa asal',
            kuk: [
      ...
      },
      {
        ...
        title: 'Memilih Metode yang Tepat Sesuai dengan Teks atau Bagian Teks yang Sedang Diterjemahkan',
        elemen: [
          {
            title: 'Mengidentifikasi karakteristik pembaca sasaran dan melakukan analisis kebutuhan',
            kuk: [
          ...
          {
            title: 'Mengidentifikasi metode penerjemahan yang tepat sesuai dengan teks atau bagian teks yang sedang diterjemahkan',
            kuk: [
      ...
      },
      {
        ...
        title: 'Memilih Teknik Penerjemahan Untuk Kata, Frasa, Klausa, dan Kalimat dalam Teks Asal',
        elemen: [
          {
            title: 'Mengidentifikasi masalah penerjemhan yang ditemukan ketika melakukan analisis teks',
            kuk: [
      ...
      },
      {
        ...
        title: 'Menulis Pesan dengan Kata, Frasa, Klausa, dan Kalimat Sesuai dengan Koteks dan Konteks',
        elemen: [
          {
            title: 'Mengidentifikasi koteks untuk memahami konteks yang melatarbelakangi teks',
            kuk: [
          ...
          {
            title: 'Menulis pesan yang diwujudkan melalui kata, frasa, klausa, dan kalimat sesuai dengan koteks dan konteks',
            kuk: [
      ...
      },
      {
        ...
        title: 'Menulis Pesan yang Diwujudkan melalui Pilihan Kata dan Gaya Bahasa sesuai dengan Bahasa Tujuan untuk Genre Teks yang Sedang Diterjemahkan',
        elemen: [
          {
            title: 'Menentukan pilihan kata dan gaya bahasa untuk menuliskan pesan sesuai dengan konvensi bahasa tujuan untuk genre teks yang sedang diterjemahkan',
            kuk: [
          ...
          {
            title: 'Menulis pesan yang diwujudkan melalui pilihan kata dan gaya bahasa yang sesuai dengan konvensi bahasa tujuan untuk genre teks yang sedang diterjemahkan',
            kuk: [
      ...
      },
      {
        ...
        elemen: [
          {
            title: 'Mengombinasikan bentuk dan makna terjemahan (kohesi dan koherensi) untuk menghasilkan keterpaduan teks',
            kuk: [
    ...
    persyaratanDasar: [
      ...
      },
      {
        ...
        description: 'Telah mengikuti magang/praktik kerja industri bidang penerjemahan bahasa.',
      },
    ],
    buktiAdministratif: ['KTP dan KTM', 'Pasfoto berwarna ukuran 3 x 4'],
  },
  {
    ...
    units: [
      ...
      },
      {
        ...
        elemen: [
          ...
          {
            title: 'Melakukan pemeriksaan terhadap pemenuhan implementasi SJH dan SJPH',
            kuk: [
    ...
    persyaratanDasar: [
      ...
      },
      {
        ...
        description: 'Telah menyelesaikan magang pada bidang penjaminan produk halal.',
      },
    ],
    buktiAdministratif: ['KTP dan KTM', 'Pasfoto berwarna ukuran 3 x 4'],
  },
    ...
    units: [
      {
        ...
        title: 'Menyusun Dokumen Penerapan Sistem Jaminan Produk Halal (SJPH) dan Kelengkapannya',
        elemen: [
          {
          ...
          {
            title: 'Melakukan analisis risiko titik kritis kehalalan sesuai dengan lingkup usaha',
            kuk: [
          ...
          {
            title: 'Menyusun manual halal, prosedur, instruksi kerja penerapan SJPH, dan kelengkapannya',
            kuk: [
      ...
      },
      {
        ...
        elemen: [
          ...
          {
            title: 'Melaporkan hasil penyiapan daftar bahan dan dokumen pendukungnya',
            kuk: [
      ...
      },
      {
        ...
        elemen: [
          ...
          {
            title: 'Melaporkan dan mendokumentasikan penanganan produk yang tidak memenuhi kriteria halal',
            kuk: [
      ...
      },
      {
        ...
        title: 'Melakukan Audit Internal Penerapan Sistem Jaminan Produk Halal (SJPH)',
        elemen: [
          {
      ...
      },
      {
        ...
        elemen: [
          {
            title: 'Melakukan evaluasi tindak lanjut perbaikan hasil audit internal',
            kuk: [
          ...
          {
            title: 'Mendokumentasikan hasil audit internal, tindak lanjut perbaikan dan pencegahan',
            kuk: [
